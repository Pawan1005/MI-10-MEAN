class Student {
    ...
    read() {
        this.rollNo  = parseInt(localStorage.getItem('rollNo'));
        this.stdName = localStorage.getItem('stdName');
        this.maths = parseInt(localStorage.getItem('maths'));
        this.science = parseInt(localStorage.getItem('science'));
        this.history = parseInt(localStorage.getItem('history'));
        this.biology = parseInt(localStorage.getItem('biology'));
        this.physics = parseInt(localStorage.getItem('physics'));
